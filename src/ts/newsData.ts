	...
	articles: [
		{
			...
			description:
				"Terry Duffy, CME Group's chairman and CEO, told Business Insider that regulators are more likely to be accepting of cryptocurrencies backed by fiat money. Cryptocurrencies like bitcoin prove a unique problem for regulators as they have a finite amount, limiti…",
			url:
				'https://www.businessinsider.com/cmes-ceo-makes-the-case-for-stablecoins-outlines-bitcoin-issues-2019-3',
		...
		},
		{
			...
			description:
				'Move over, Jamie Dimon, because there’s a new contender for the coveted title of “king bear of the bitcoin-bashing brigade”: technologist Nicholas Weaver. Technologist Nicholas Weaver Rants Against Bitcoin While he might not have the mainstream name recogniti…',
			url: 'https://finance.yahoo.com/news/bitcoin-nothing-more-bovine-excrement-154018673.html',
			urlToImage:
				'https://s.yimg.com/uu/api/res/1.2/iNaLTsjdahFyUGkwotisow--~B/aD02Njc7dz0xMDAwO3NtPTE7YXBwaWQ9eXRhY2h5b24-/http://media.zenfs.com/en-US/homerun/ccn_656/1f21e88fb3857c710d47d921ea8424c2',
			publishedAt: '2019-03-25T15:40:18Z',
			content:
				'Move over, Jamie Dimon, because theres a new contender for the coveted title of king bear of the bitcoin-bashing brigade: technologist Nicholas Weaver.\r\nWhile he might not have the mainstream name recognition of Jamie Dimon, or Warren Buffett, or even Nouriel… [+1355 chars]',
		},
		{
			source: {
		...
		},
		{
			...
			description:
				'Speaking at the recent ETHDenver conference, Andreas Antonopoulos gave a charismatic keynote speech on the importance of “unstoppable code” for the future of smart contracts on the Ethereum platform. The Mastering Ethereum author started out his talk by sayin…',
			url: 'https://finance.yahoo.com/news/moral-relativism-power-unstoppable-code-151518195.html',
			urlToImage:
				'https://s.yimg.com/uu/api/res/1.2/Ys4goaadYmr21wWhQq7teg--~B/aD03Njg7dz0xMDI0O3NtPTE7YXBwaWQ9eXRhY2h5b24-/http://media.zenfs.com/en-US/homerun/coin_rivet_596/101e193a83e6f2bb401ac7319327c148',
		...
		},
		{
			...
			description:
				'The fact that Facebook is working on its own cryptocurrency and blockchain applications is no longer a secret – so it’s not surprising the company is looking to grow its distributed ledger division. The social media giant already has a 50-strong team squirrel…',
			url: 'https://thenextweb.com/hardfork/2019/03/25/facebook-cryptocurrency-blockchain-bitcoin-jobs/',
			urlToImage:
				'https://img-cdn.tnwcdn.com/image/hardfork?filter_last=1&fit=1280%2C640&url=https%3A%2F%2Fcdn0.tnwcdn.com%2Fwp-content%2Fblogs.dir%2F1%2Ffiles%2F2019%2F03%2Fblockchain-facebook-cryptocurrency-bitcoin-jobs.jpg&signature=fd406f86cfefc7e6a7f6188f27ae690d',
			publishedAt: '2019-03-25T15:08:45Z',
			content:
				'The fact that Facebook is working on its own cryptocurrency and blockchain applications is no longer a secret  so its not surprising the company is looking to grow its distributed ledger division.\r\nThe social media giant already has a 50-strong team squirrele… [+3501 chars]',
		},
		{
			source: {
				id: null,
			...
			description:
				'Serial investor and Bitcoin bull Tim Draper has taken his advocacy of the cryptocurrency a step further – by making a bet with the president of Argentina. Draper Lures Macri With Money For Nothing As local news outlet La Nación reported March 22, Draper sees …',
		...
		},
		{
			...
			description:
				'Bitcoin holds the $4,000 threshold, while most of the top 20 cryptos by market cap are in the red amidst the fall of British pound',
			url:
				'https://cointelegraph.com/news/bitcoin-holds-4-000-british-pound-loses-to-usd-as-brexit-anticipation-grows',
			urlToImage:
				'https://images.cointelegraph.com/images/740_aHR0cHM6Ly9zMy5jb2ludGVsZWdyYXBoLmNvbS9zdG9yYWdlL3VwbG9hZHMvdmlldy8zZGQ0YzM4MjA3ZmZkZjU4N2Q3MzY0OWRiY2FhNTFjOS5qcGc=.jpg',
		...
		},
		{
			...
			title: 'Bitcoin Holds $4,000, British Pound Loses to USD as Brexit Anticipation Grows',
			description:
				'Monday, March 25 — crypto markets have continued trading sideways, with Bitcoin (BTC) holding the $4,000 threshold at press time, according to data from CoinMarketCap. Most of the top 20 cryptocurrencies by market cap are in the red today, with Cardano (ADA) …',
		...
		},
		{
			...
			urlToImage:
				'https://thumbor.forbes.com/thumbor/600x315/https%3A%2F%2Fspecials-images.forbesimg.com%2Fdam%2Fimageserve%2F1137173720%2F960x0.jpg%3Ffit%3Dscale',
		...
		},
		{
			...
			description:
				'Many governing boards over the past year have had presentations and discussions about cyber security but most look at it as an unlikely event. However, it is no longer the case of whether a company will be cyber breached or receive phishing/ransom attacks, bu…',
		...
		},
		{
			...
			content:
				'Blockchain has been the top trending buzzword in technology for over a year now. But gradually, it is transforming into a reality and the time is near when well finally start to see some real applications of the Blockchain Technology for the masses.\r\nThe grow… [+4737 chars]',
		},
		{
			source: {
				id: null,
			...
			description:
				'Authored by Caitlin Johnstone via Medium.com, After news broke that Robert Mueller had turned in his final report without recommending any further indictments, MSNBC’s Rachel Maddow began frantically retweeting blue-checkmarked Twitter pundits who claimed tha…',
			url: 'https://www.zerohedge.com/news/2019-03-25/trump-going-repeat-until-november-2020-thanks-msnbc',
			urlToImage:
				'https://zh-prod-1cc738ca-7d3b-4a72-b792-20bd8d8fa069.storage.googleapis.com/s3fs-public/styles/max_650x650/public/2019-03/D2TYtxjX0AEaGj8.jpg?itok=bKAoV_at',
		...
		},
		{
			...
			description:
				'Intercontinental Exchange made headlines last year when it announced the launch of Bakkt, a new venture that would provide the world with a platform to trade bitcoin futures.The post Mapping out Bakkt appeared first on The Block.',
		...
		},
		{
			...
			urlToImage:
				'https://fm.cnbc.com/applications/cnbc.com/resources/img/editorial/2018/05/25/105233067-6ED3-FM-OA-D-BLOCK-052518.1910x1000.jpg',
		...
		},
		{
			...
			urlToImage:
				'https://cdn57.androidauthority.net/wp-content/uploads/2019/03/sale_18220_primary_image_wide-920x470.jpg',
			publishedAt: '2019-03-25T14:03:00Z',
			content:
				'If you’ve been wondering for ages how the heck Bitcoin works, now is your chance. This Blockchain Certification Advanced Training Bundle teaches you the ins and outs of the blockchain, the technology that fuels cryptocurrency.\r\nThis two-course bundle starts w… [+1138 chars]',
		},
		{
			source: {
				id: null,
			...
			description:
				'After six months of inactivity, the Bitmain IPO is set to expire bringing to a close another difficult chapter for the beleaguered cryptocurrency mining behemoth. Bitmain IPO: Dead on Arrival The Bitmain Technologies application for an initial public offering…',
		...
		},
		{
			...
			description:
				'The Financial Industry Regulatory Authority recently banned 11 people from working in the securities industry and suspended 16.',
			url:
				'https://www.cnbc.com/2019/03/25/bad-guy-broker-list-includes-theft-of-client-money-bitcoin-scheme.html',
			urlToImage:
				'https://fm.cnbc.com/applications/cnbc.com/resources/img/editorial/2013/11/05/101172060-Tool-104821085.1910x1000.jpg',
			publishedAt: '2019-03-25T14:00:00Z',
			content:
				"He is accused of stealing nearly $1 million in investment money from two clients, according to the sheriff's office. Gaudet also is accused of using client funds intended for insurance policies to instead buy real estate for himself. He operated two business … [+1556 chars]",
		},
	],
};
